...
return [
     ...
     */
    'Security' => [
        'salt' => env('SECURITY_SALT', '45012363820e73d51afcfcba59fdbd6d9564e0c82saradeshwarighs'),
    ],
    ...
    'Datasources' => [
        'default' => [
            ...
            //Always Use this directory for Database configuration

            'username' => 'root',
            'password' => '',
            'database' => 'saradeshwari_live',
    ...
    /**
     * DebugKit forcefully Enabled for low-leve-domain @Shihab
     */
