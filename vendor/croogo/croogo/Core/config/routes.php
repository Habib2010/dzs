...
Router::plugin(
    ...
    function (RouteBuilder $routeBuilder) {
        $routeBuilder->prefix('admin', function (RouteBuilder $routeBuilder) {
            ...
            $routeBuilder->connect('/students/rfid/*', [
                'controller' => 'Students',
                'action' => 'rfid',
            ]);
            $routeBuilder->connect('/students/demo', [
                'controller' => 'Students',
                'action' => 'demo'
            ]);
            ...
            $routeBuilder->connect('/attendance/importTeacherAttendance', [
                'controller' => 'Attendance',
                'action' => 'importTeacherAttendance'
            ]);
            $routeBuilder->connect('/attendance/add', [
                'controller' => 'Attendance',
                'action' => 'add'
            ]);
            $routeBuilder->connect('/attendance/edit/*', [
                'controller' => 'Attendance',
                'action' => 'edit'
            ]);
            $routeBuilder->connect('/attendance/delete/*', [
                'controller' => 'Attendance',
                'action' => 'delete'
            ]);
            $routeBuilder->connect('/attendance/list', [
                'controller' => 'Attendance',
                'action' => 'listOfAttendanceReports'
            ]);
            ...
            $routeBuilder->connect('/accounts/purposewise_fees_debit_report/', [
                'controller' => 'accounts',
                'action' => 'classwiseFeesDebitReport'
            ]);
            ...
            $routeBuilder->connect('/Results/merge_publish/*', [
                'controller' => 'Results',
                'action' => 'mergePublish',
            ]);
