...
?>
        ...
        <div class="container">
            <div class="header">
                ...
                <?= __d('students', 'Search Merge Result') ?>
                </h3>
            </div>
        ...
        <div class="rows">
            <h3 class="text-center"><?= __d('Result', 'List of Merge Result') ?></h3>
            <span class="text-right float-right mb-3"><?php echo $this->Html->link('Generate Merge Result', ['action' => 'generateMergeResult'], ['class' => 'btn btn-info']) ?></span>
                ...
                <tr>
                    ...
                    <?php
                        echo $this->Form->postLink(
                            $result['merge_publish'] == 1 ? 'Unpublish' : 'Publish',
                            ['action' => 'mergePublish', $result['result_id']],
                            [
                                'class' => $result['merge_publish'] == 1 ? 'btn btn-danger' : 'btn btn-success',
                                'confirm' => $result['merge_publish'] == 1
