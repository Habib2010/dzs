...
<body>
    <div class="container">
        <div class="header">
            <h3 class=" text-center" style="letter-spacing: 3px; word-spacing: 7px; text-transform:capitalize;">
                <?= __d('attendance', 'Add Scholarship Status') ?>
            </h3>
        </div>
    ...
    ?>
        <div style="background-color: #f2f2f2; padding: 10px; margin-top: 50px;">
            ...
            $this->Form->unlockField('date');
            $this->Form->unlockField('tution_fees');
            ?>
                ...
                <tbody>
                    ...
                    foreach ($students as $student) { ?>
                        <tr class="single_row">
                            ...
                            <td>
                                <input name="tution_fees[<?php echo $student['student_cycle_id']; ?>]" type="text" class="form-control" value="<?php echo $student['tuition_fee_status']; ?>">
                        </tr>
                    <?php } ?>
