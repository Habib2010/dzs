        ...
        <table class=" display_table table table-hover mt-5">
            <tbody>
                ...
                <tr>
                    ...
                    <th>Course:</th>
                    <td colspan="6"><?= $head['course_name']['course_name'] . '(' . $head['course_name']['course_code'] . ')' . ' : ' . $head['course_name']['course_type_name']  ?></td>
                </tr>
            </tbody>
        </table>
            ...
            <table class="table table-bordered table-striped">
                ...
                <td>
                    ...
                    <?php } ?>
                                    ...
                                    <?php foreach ($scms_term_course_cycle_parts as $part) { ?>
                            <input name="max_marks[<?php echo $part['term_course_cycle_part_type_name'] ?>]" type="hidden" class="max_marks-<?php echo $part['term_course_cycle_part_type_name']?>" value='<?php echo $part['mark'] ?>'>
                               <?php } ?>
                            <div class="mt-5">
