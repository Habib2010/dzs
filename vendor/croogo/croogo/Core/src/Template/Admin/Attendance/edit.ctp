				...
				<div class="form_area p-3">
					...
					<div class="form_area p-2">
						<div class="row mb-3">
							...
							<div class="col-lg-4">
								<input name="inn" id="checkInTime" type="time" class="form-control" value="<?= $get_datas[0]['inn']; ?>">
							</div>
						</div>
						<div class="row mb-3">
							<div class="col-lg-2">
							...
							<div class="col-lg-4">
								<input name="outt" id="checkOutTime" type="time" class="form-control" value="<?= $get_datas[0]['outt']; ?>">
							</div>
						</div>
						<div class="row mb-3">
							<div class="col-lg-2">
							...
							<div class="col-lg-4">
								<input name="statuss" type="text" class="form-control" value="<?= $get_datas[0]['statuss']; ?>">
							</div>
						</div>
						<div class="row mb-3">
							<div class="col-lg-2">
							...
							<div class="col-lg-4">
								<input name="color" type="color" class="form-control" value="<?= $get_datas[0]['color']; ?>">
							</div>
						</div>
						<div class="mt-5">
