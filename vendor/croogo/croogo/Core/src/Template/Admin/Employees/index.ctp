...
<style>
    table.list_employee td{
        vertical-align: middle!important;
    }
    table.list_employee td img{
    ...
    <body>
        ...
        <div class="rows">
            ...
            <span class="text-right float-right mb-3"><?= $this->Html->link('Add Employee', ['action' => 'addEmployee'], ['class' => 'btn btn-info']) ?></span>
            <?= $this->Html->link('Update Employee Unique IDs', ['action' => 'updateUniqueIds'], ['class' => 'button']) ?>
        </div>
        <table class="table table-bordered table-striped list_employee">
            <thead class="thead-dark">
                <tr>

                    <th><?= __d('employees', '#') ?></th>
                     <th><?= __d('employees', 'E.No') ?></th>
