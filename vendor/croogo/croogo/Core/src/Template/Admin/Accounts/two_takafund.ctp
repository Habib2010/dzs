...
<html lang="en">
        ...
        <div class="container">
            <div class="header">
                <h3 class=" text-center" style="letter-spacing: 3px; word-spacing: 7px; text-transform:capitalize;">
                            <?= __d('attendance', 'Two Taka Fund Collection') ?>
                </h3>
            </div>
    ...
    <center style="margin-top:50px; font-weight:bold; font-size:1.2em"></center>
            ...
            $this->Form->unlockField('date');
            $this->Form->unlockField('two_taka_fees');
            ?>
    <table class="table table-bordered table-striped">
        ...
        <tbody>
            ...
            <tr class="single_row">
                ...
                <td>
                    <input name="two_taka_fees[<?php echo $student['student_cycle_id']; ?>]" type="text" class="form-control">
            </tr>
                    <?php } ?>
